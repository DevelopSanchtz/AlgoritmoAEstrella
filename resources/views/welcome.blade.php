...
<body onload="inicializa();">
    ...
    <h1 style = "text-align: center;">ALGORITMO A ESTRELLA</h1>
    <h2 style = "text-align: center;">Encontrar el camino más corto con JAVASCRIPT</h2>
    
    <canvas id="canvas" width="500" height="500" style="border: 20px solid #000000; margin-left: 500px; margin-top: 100px;">
...
function algoritmo(){
  ...
  if(terminado!=true){
    ...
    if(openSet.length>0){
      ...
      console.log('El algoritmo no ha encontrado algún camino');
